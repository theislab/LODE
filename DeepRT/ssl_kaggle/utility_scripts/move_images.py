...
save_dir = "/media/olle/Seagate/kaggle/tensorflow.keras_format/pre_proc/512_25/validation"
...
for im in ids["image"].values:
    try:
        ...
        shutil.copy(src=os.path.join(gen_data,im+".jpeg"),dst=os.path.join(tensorflow.keras_d,str(label)))
    except:
        print(im)
'''